...
CONFIG="configs/baselines/rotated_retinanet_obb_r50_fpn_rsar_le90_100kiter.py"
RUN_TAG="${DINO_SAR_RUN_TAG:-6class}"
BASE_WORK_DIR="outputs/multiseed_${RUN_TAG}/baseline_r50_100k"
BASE_EVAL_DIR="outputs/eval_${RUN_TAG}/multiseed_baseline_r50_100k"
