...
CONFIG="configs/baselines/rotated_retinanet_obb_r50_fpn_rsar_le90_cb0p1_100kiter.py"
RUN_TAG="${DINO_SAR_RUN_TAG:-6class_cb0p1}"
BASE_WORK_DIR="outputs/multiseed_${RUN_TAG}/baseline_r50_cb0p1_100k"
BASE_EVAL_DIR="outputs/eval_${RUN_TAG}/multiseed_baseline_r50_cb0p1_100k"
