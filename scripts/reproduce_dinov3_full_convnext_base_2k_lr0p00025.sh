...
CONFIG="configs/dinov3_full/retinanet_dinov3_timm_convnext_base_fpn_rsar_le90_full_2kiter_lr0p00025.py"
WORK_DIR="outputs/reproduce_${RUN_TAG}/dinov3_full_convnext_base_2k_lr0p00025/seed${SEED}"
EVAL_DIR="outputs/eval_${RUN_TAG}/reproduce_dinov3_full_convnext_base_2k_lr0p00025/seed${SEED}"
