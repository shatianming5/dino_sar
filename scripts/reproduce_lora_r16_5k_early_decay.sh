...
WORK_DIR="outputs/dinov3_lora/retinanet_timm_convnext_small_dinov3_lora_r16_train_5kiter_early_decay"
EVAL_DIR="outputs/eval/dinov3_lora_r16_5k_early_decay_val"
