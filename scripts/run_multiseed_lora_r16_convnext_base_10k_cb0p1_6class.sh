...
CONFIG="configs/dinov3_lora/retinanet_dinov3_timm_convnext_base_fpn_rsar_le90_lora_r16_10kiter_cb0p1.py"
RUN_TAG="${DINO_SAR_RUN_TAG:-6class_cb0p1}"
BASE_WORK_DIR="outputs/multiseed_${RUN_TAG}/lora_r16_convnext_base_cb0p1_10k"
BASE_EVAL_DIR="outputs/eval_${RUN_TAG}/multiseed_lora_r16_convnext_base_cb0p1_10k"
