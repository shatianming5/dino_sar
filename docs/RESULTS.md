...
| LoRA r=16 target=stages2+3 + convdown (10k iters) `configs/lora_target_ablation/retinanet_dinov3_timm_convnext_small_fpn_rsar_le90_lora_r16_stage23_convdown_10kiter.py` | 0.5374 | - | - | - | - |
