...
- stages_2 only 10k：`scripts/reproduce_lora_r16_stage2_10k.sh`
...
- LoRA r16 ConvNeXt-Base 10k（seed=0/1/2）：`scripts/run_multiseed_lora_r16_convnext_base_10k_6class.sh`
